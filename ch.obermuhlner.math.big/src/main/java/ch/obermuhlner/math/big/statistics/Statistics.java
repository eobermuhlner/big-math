...
//import ch.obermuhlner.math.big.statistics.univariate.list.PopulationSkewnessCalculator;
...
public class Statistics {
    ...
    public static BigDecimal populationSkewness(List<BigDecimal> values, MathContext mathContext) {
        return new UnivariateStreamAsListCalculator<>(new PopulationSkewnessCalculator(mathContext)).getResult(values);
        //return new PopulationSkewnessCalculator(mathContext).getResult(values);
    }
