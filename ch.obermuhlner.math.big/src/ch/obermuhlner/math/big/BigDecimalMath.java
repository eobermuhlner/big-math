...
public class BigDecimalMath {
	...
	private static final BigDecimal PI = new BigDecimal("3.");                               
	
	private static final BigDecimal ROUGHLY_TWO_PI = new BigDecimal("3.141592653589793");
...
//		return logUsingTwoThree(x, mathContext);
	...
	public static BigDecimal pi(MathContext mathContext) {
		...
		throw new UnsupportedOperationException(); // TODO impl pi()
	}
